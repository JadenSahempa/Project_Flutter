...
class PrakerjaCoursesTab extends StatelessWidget {
  const PrakerjaCoursesTab({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final items = c.prakerjaCourses;

        if (items.isEmpty) {
          return const Center(child: Text('Belum ada kelas Prakerja.'));
        }
