...
// import 'package:luar_sekolah_lms/week_7/data/datasources/course_remote_data_source.dart';
...
//     final c = Get.put(
//       CourseController(api: CourseApiService()),
//       tag: 'popular',
//     );
...
//                     if (ok == true) {
//                       try {
//                         await c.api.deleteCourse(item.id);
//                         // opsi 1: refresh dari server
//                         await c.reload();
