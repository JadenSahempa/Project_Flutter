  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/dashboard-populer': (context) => const KelasTerpopulerScreen(),
      },
    );
  }
}
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              PageCard(
                title: 'Dashboard - Kelas Terpopuler',
                subtitle: 'Klik untuk masuk ke Dashboard - Kelas Terpopuler',
                route: '/dashboard-populer',
              ),
            ],
          ),
        ),
